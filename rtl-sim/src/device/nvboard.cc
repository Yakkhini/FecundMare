...
void nvboard_bind_all_pins() {
  ...
  nvboard_bind_pin(&cpu.top->externalPins_uart_rx, 1, UART_RX);

  nvboard_bind_pin(&cpu.top->externalPins_ps2_clk, 1, PS2_CLK);
  nvboard_bind_pin(&cpu.top->externalPins_ps2_data, 1, PS2_DAT);

  nvboard_bind_pin(&cpu.top->externalPins_vga_r, 8, VGA_R7, VGA_R6, VGA_R5,
                   VGA_R4, VGA_R3, VGA_R2, VGA_R1, VGA_R0);
  nvboard_bind_pin(&cpu.top->externalPins_vga_g, 8, VGA_G7, VGA_G6, VGA_G5,
                   VGA_G4, VGA_G3, VGA_G2, VGA_G1, VGA_G0);
  nvboard_bind_pin(&cpu.top->externalPins_vga_b, 8, VGA_B7, VGA_B6, VGA_B5,
